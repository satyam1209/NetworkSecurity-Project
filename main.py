...
from networksecurity.enitity.config_entity import DataIngestionConfig,TrainingPipelineConfig,DataValidationConfig
...
try:
    ...
    print("artifact",data_validation_artifact)
